...
type GameState = { state: 'playing' } | { state: 'end', winner: 'O' | 'X' | 'draw' };
    ...
    return (
        <View style={styles.board}>
            ...
            <View>
                ...
                }}><Text style={styles.reset}>reset</Text></Pressable>
            </View>
        </View>
    );
};

const Square = ({field, onPress}: { field: SquareState, onPress: () => void, }) => (
