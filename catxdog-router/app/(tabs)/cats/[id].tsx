    ...
    return (
        <View>
            ...
            <View>
                ...
                <Text style={styles.text}>Weight: {cat.weight.metric} kg</Text>
                <Text style={styles.text}>Lifespan: {cat.life_span} years</Text>
                <Text style={styles.text}>Child friendliness: {cat.child_friendly}</Text>
            </View>
        </View>
    );
};
